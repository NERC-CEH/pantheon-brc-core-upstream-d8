...
class SynonymsEntity extends Entity {
  ...
  public function validateArgument($argument) {
    ...
    foreach (\Drupal::getContainer()->get('synonyms.provider_service')->getSynonymConfigEntities($entity_type->id(), empty($this->options['bundles']) ? NULL : $this->options['bundles']) as $synonym_config) {

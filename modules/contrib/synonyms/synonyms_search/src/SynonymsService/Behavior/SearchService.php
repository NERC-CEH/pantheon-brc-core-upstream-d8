...
class SearchService implements BehaviorInterface {
   ...
   */
  public function __construct(EntityFieldManagerInterface $entity_field_manager, EntityTypeManagerInterface $entity_type_manager, Connection $database, TimeInterface $time) {
  ...
  protected function getEntitySynonyms(ContentEntityInterface $entity) {
    ...
    if (\Drupal::getContainer()->get('synonyms.behavior_service')->serviceIsEnabled($entity->getEntityTypeId(), $entity->bundle(), $this->getId())) {
